...
namespace margelo::nitro::nitrogeocoder {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "GeocodeResult" and the the Kotlin data class "GeocodeResult".
   */
  struct JGeocodeResult final: public jni::JavaClass<JGeocodeResult> {
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitrogeocoder/GeocodeResult;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct GeocodeResult by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    GeocodeResult toCpp() const {
  ...
  public:
     ...
     */
    [[maybe_unused]]
    static jni::local_ref<JGeocodeResult::javaobject> fromCpp(const GeocodeResult& value) {
      using JSignature = JGeocodeResult(double, double, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<JGeocodingConfidence>);
      static const auto clazz = javaClassStatic();
