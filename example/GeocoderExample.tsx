...
export default function GeocoderExample() {
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Geocoder Example</Text>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.cardSubtitle}>Riyadh ↔ Mecca (synchronous, ultra-fast)</Text>
        ...
        <View style={styles.resultCard}>
          ...
          {result.state && (
            <View style={styles.resultRow}>
              ...
              <Text style={styles.resultValue}>{result.state}</Text>
            </View>
          )}
          ...
          {result.postalCode && (
            <View style={styles.resultRow}>
              <Text style={styles.resultLabel}>Postal Code:</Text>
              <Text style={styles.resultValue}>{result.postalCode}</Text>
            </View>
          )}
